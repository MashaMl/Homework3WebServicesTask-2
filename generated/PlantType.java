...
public class PlantType implements Comparator<PlantType> {
    ...
    @Override
    public int compare(PlantType o1, PlantType o2) {
        return o1.growingTips.watering.compare(o1.growingTips.watering, o2.growingTips.watering);
    }
}
